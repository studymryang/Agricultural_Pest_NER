...
from model import BertBiLSTMNer,BertBiGRUNer,BiGRUNer,BiLSTMNer,BertCrfNer,BertGlyphBiLSTMNer
...
class Trainer:
    ...
    def validate(self):
        ...
        values = re.findall(r'\d+\.\d+', lines[-3])
    ...
    def test(self):
        self.model.load_state_dict(torch.load(os.path.join(self.output_dir, "best_model.bin")))
        self.model.eval()
        preds = []
        trues = []
